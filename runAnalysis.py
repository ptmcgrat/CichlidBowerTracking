...
parser.add_argument('AnalysisType', type=str, choices=['Prep', 'Depth', 'Cluster', 'ClusterClassification', 'TrackFish', 'AssociateClustersWithTracks', 'AddFishSex','Summary', 'AssociateClustersWithSex'],
...
while len(projectIDs) != 0:
    ...
    elif args.AnalysisType == 'AssociateClustersWithSex':
        p1 = subprocess.Popen(
            ['python3', '-m', 'cichlid_bower_tracking.unit_scripts.associate_clusters_with_sex', projectID, args.AnalysisID])

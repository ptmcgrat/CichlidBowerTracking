...
parser.add_argument('DataType', type = str, choices=['Prep','Depth','Cluster','ClusterClassification','TrackFish','AssociateClustersWithTracks', 'AddFishSex', 'Train3DResnet','TrainRCNN','ManualAnnotation','ManualLabelVideos','ManualLabelFrames', 'Summary','All', 'AssociateClustersWithTracks', 'AssociateClustersWithSex'], help = 'What type of analysis to perform')

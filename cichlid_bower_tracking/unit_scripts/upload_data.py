...
parser.add_argument('DataType', type = str, choices=['Prep','Depth','Cluster','ClusterClassification', 'TrackFish', 'Train3DResnet', 'ManualLabelVideos','Summary','All', 'AddFishSex'], help = 'What type of analysis to perform')

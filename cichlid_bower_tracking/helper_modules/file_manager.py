...
class FileManager():
	def __init__(self, analysisID='HybridMulti', projectID='mccv_s#_tr1_BowerBuilding', rcloneRemote = 'CichlidPiData:/', masterDir = 'CoS/BioSci/BioSci-McGrath/Apps/CichlidPiData/', check = False):

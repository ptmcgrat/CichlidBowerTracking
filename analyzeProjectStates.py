...
columns = ['projectID', 'Notes', 'tankID', 'RunAnalysis', 'StartingFiles', 'Prep', 'Depth', 'Cluster', 'ClusterClassification', 'TrackFish','AddFishSex','AssociateClustersWithSex', 'AssociateClustersWithTracks', 'Summary']
